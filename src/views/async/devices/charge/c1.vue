		...
		<div class="flex4 hh100 flex-sc warp mr15">
           <div class="ww50 hh33 plr5 flex-col-cc">
			   <div class="flex-col-cc ptb4 ww100 bs2">
                  <span>充电桩总数量（个）</span>
				  <span class="white f16 mt2">300</span>
			   </div>
		   </div>
           <div class="ww50 hh33 plr5 flex-col-cc">
			   <div class="flex-col-cc ptb4 ww100 bs2">
                  <span>当前充电桩使用中（个）</span>
				  <span class="white f16 mt2">201</span>
			   </div>
		   </div>
           <div class="ww50 hh33 plr5 flex-col-cc">
			   <div class="flex-col-cc ptb4 ww100 bs2">
                  <span>全站实时充电功率（MW）</span>
				  <span class="white f16 mt2">6.2</span>
			   </div>
		   </div>
           <div class="ww50 hh33 plr5 flex-col-cc">
			   <div class="flex-col-cc ptb4 ww100 bs2">
                  <span>全站总容量（MWh）</span>
				  <span class="white f16 mt2">10.29</span>
			   </div>
		   </div>
           <div class="ww50 hh33 plr5 flex-col-cc">
			   <div class="flex-col-cc ptb4 ww100 bs2">
                  <span>当前充电负荷率（%）</span>
				  <span class="white f16 mt2">10.2</span>
			   </div>
		   </div>
           <div class="ww50 hh33 plr5 flex-col-cc">
			   <div class="flex-col-cc ptb4 ww100 bs2">
                  <span>全站充电功率设定值（MW）</span>
				  <span class="white f16 mt2">18.03</span>
			   </div>
		   </div>
		</div>
