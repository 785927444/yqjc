		...
		<div class="ww100 hh100 flex-sc absolute pl35">
			...
			<div class="flex-ec flex1">
				<el-select v-model="state.station" placeholder="请选择" style="width: 30%" clearable filterable @change="state.sensor_id=''">
					...
					<el-option v-for="(v, i) in dictStore.stations2" :key="v.id" :label="v.name" :value="v.id" />
				</el-select>
		...
		<div class="flex4 hh100 flex-sc warp mr15">
           <div class="ww50 hh33 plr5 flex-col-cc">
			   <div class="flex-col-cc ptb4 ww100 bs2">
                  <span>今日充电量（kWh）</span>
				  <span class="white f16 mt2">8.23</span>
			   </div>
		   </div>
           <div class="ww50 hh33 plr5 flex-col-cc">
			   <div class="flex-col-cc ptb4 ww100 bs2">
                  <span>今日放电量（kWh）</span>
				  <span class="white f16 mt2">5.23</span>
			   </div>
		   </div>
           <div class="ww50 hh33 plr5 flex-col-cc">
			   <div class="flex-col-cc ptb4 ww100 bs2">
                  <span>当月充电量（kWh）</span>
				  <span class="white f16 mt2">183.54</span>
			   </div>
		   </div>
           <div class="ww50 hh33 plr5 flex-col-cc">
			   <div class="flex-col-cc ptb4 ww100 bs2">
                  <span>当月放电量（kWh）</span>
				  <span class="white f16 mt2">160.21</span>
			   </div>
		   </div>
           <div class="ww50 hh33 plr5 flex-col-cc">
			   <div class="flex-col-cc ptb4 ww100 bs2">
                  <span>当年充电量（kWh）</span>
				  <span class="white f16 mt2">13183.03</span>
			   </div>
		   </div>
           <div class="ww50 hh33 plr5 flex-col-cc">
			   <div class="flex-col-cc ptb4 ww100 bs2">
                  <span>当年放电量（kWh）</span>
				  <span class="white f16 mt2">27803.03</span>
			   </div>
		   </div>
		</div>
