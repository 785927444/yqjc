<template>
  <div class="layout-col">
		<!-- 标题 -->
		<aa-title title="充放电功率情况"><template #right-content></template></aa-title>
    <!-- 内容 -->
    <div class="layout-col p12 ba1 relative">
			<div class="absolute tt40 l10 z1" style="color: #FFC860; opacity: 0.5;" v-if="!isNull(publicStore._public.DevicesPower)">放电</div>
      <div class="absolute tt52 b90 l10 z1" style="color: #60E7FF; opacity: 0.5;" v-if="!isNull(publicStore._public.DevicesPower)">充电</div>
