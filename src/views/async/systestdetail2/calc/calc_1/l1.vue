<template>
  <div class="layout-col">
    ...
    <div class="layout-col ba1 p20 i15">
      ...
      <div class="flex-sc cursor mb15 z1 relative">
        <span class="w50x2 mr10">选择算法</span>
        <span class="white" v-if="!isNull(publicStore._public) && !isNull(publicStore._public.algorithms)">{{ publicStore.active&&publicStore.active.attr&&publicStore.active.attr.algorithm?find(publicStore._public.algorithms, ['value', publicStore.active.attr.algorithm], 'name'):'' }}</span>
      </div>
      <!-- <div class="flex-sc cursor mb15 z1 relative">
      ...
      <div class="flex-col cursor mb15 z1 relative">
        <span class="w50x2 mr10">选择设备</span>
