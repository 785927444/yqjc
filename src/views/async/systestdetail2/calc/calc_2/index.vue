...
<script lang="ts" setup>
  ...
  // 初始化数据
    ...
    let res = await publicStore.http({Api: query, Api1: query1, Api2: query2, Api3: query3})
    publicStore._public.algorithms = proxy.isNull(res.Api)? [] : res.Api
