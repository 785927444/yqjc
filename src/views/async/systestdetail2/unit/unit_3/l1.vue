<template>
  <div class="layout-col">
    ...
    <div class="layout-col ba1 p20 i15">
      ...
      <div class="flex-sc cursor mb15 z1 relative">
        <span class="w50x2 mr10">目标功率</span>
        <span class="white">{{ publicStore.active&&publicStore.active.attr&&publicStore.active.attr.power?publicStore.active.attr.power:'' }} kW</span>
      </div>
      <div class="flex-sc cursor mb15 z1 relative">
