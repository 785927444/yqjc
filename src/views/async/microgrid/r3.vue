  ...
  <div class="layout-col">
    ...
    <div class="h40 ww100 flex-sc relative mb10">
      ...
      <div class="ww100 hh100 flex-sc absolute pl35">
        <span class="fw flex1 ptb5">当前能源消耗负荷曲线</span>
    ...
    <div class="layout-col p20 ba1">
      <div class="hh100 ww100" id="Line_rangeData2"></div>
    </div>
  </div>
</template>
...
<script lang="ts" setup>
  ...
  watch(() => publicStore._public.rangeData2, async(val, old) => {
	...
	const setChart = async() => {
		...
		let data = publicStore._public.rangeData2
		let series = {data: []}
		series = data.map(v => {
