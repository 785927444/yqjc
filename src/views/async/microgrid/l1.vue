  ...
  <div class="layout-col">
	...
	<div class="h40 ww100 flex-sc relative mb10">
		...
		<div class="ww100 hh100 flex-sc absolute pl35">
			<span class="fw flex1 ptb5">当日负荷运行情况</span>
			<div class="flex-ec flex1"></div>
		</div>
	</div>
    <!-- 内容 -->
    <div class="layout-col p20 ba1">
      <div class="hh100 ww100" id="Line_loadData4"></div>
    </div>
  </div>
</template>
...
<script lang="ts" setup>
  ...
  watch(() => publicStore._public.loadData4, async(val, old) => {
	...
	const setChart = async() => {
		...
		let data = publicStore._public.loadData4
		let series = {data: []}
		series = data.map(v => {
