  ...
  <div class="layout-col">
    ...
    <div class="h40 ww100 flex-sc relative mb10">
      ...
      <div class="ww100 hh100 flex-sc absolute pl35">
        <span class="fw flex1 ptb5">未来25年净现值</span>
    ...
    <div class="layout-col p20 ba1">
      <div class="hh100 ww100" id="Line_actionData1"></div>
    </div>
  </div>
</template>
...
<script lang="ts" setup>
  ...
  watch(() => publicStore._public.actionData1, async(val, old) => {
    console.log(publicStore._public.actionData1, 'publicStore._public.actionData1')
	...
	const setChart = async() => {
		...
		let data = publicStore._public.actionData1
