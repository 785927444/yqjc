<template>
  <div class="layout-col">
   ...
   <div class="ww100 flex-sc ba9 h40 mb15">
	  ...
	  <div class="cursor hh100 ptb10 plr20 ba10" @click="toPath('/demand2')">邀约下发</div>
...
<script lang="ts" setup>
  ...
  let time_types = $ref([
    {value: '0', name: '约时', color: 'i21'},
    {value: '1', name: '约时', color: 'i8'},
    {value: '2', name: '约时', color: 'ca'},
  ])
  let statuss = $ref([
  ...
  const state = reactive({
    ...
    content: [
      ...
      { width: 'w50x4', show: true, align: 'left',  key: 'project_name', name: '项目名称' },
