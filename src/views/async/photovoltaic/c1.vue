		...
		<div class="ww100 hh100 flex-sc absolute pl35">
			...
			<div class="flex-ec flex1">
				<el-select v-model="state.station" placeholder="请选择" style="width: 30%" clearable filterable @change="state.sensor_id=''">
					...
					<el-option v-for="(v, i) in dictStore.stations" :key="v.id" :label="v.name" :value="v.id" />
				</el-select>
		...
		<div class="flex4 hh100 flex-sc warp mr15">
           <div class="ww50 hh33 plr5 flex-col-cc">
			   <div class="flex-col-cc ptb4 ww100 bs2">
                  <span>历史最大出力（MW）</span>
				  <span class="white f16 mt2">35.23</span>
			   </div>
		   </div>
           <div class="ww50 hh33 plr5 flex-col-cc">
			   <div class="flex-col-cc ptb4 ww100 bs2">
           ...
           <div class="ww50 hh33 plr5 flex-col-cc">
			   <div class="flex-col-cc ptb4 ww100 bs2">
                  <span>实时出力（MW）</span>
				  <span class="white f16 mt2">12.03</span>
			   </div>
		   </div>
           <div class="ww50 hh33 plr5 flex-col-cc">
			   <div class="flex-col-cc ptb4 ww100 bs2">
           ...
           <div class="ww50 hh33 plr5 flex-col-cc">
			   <div class="flex-col-cc ptb4 ww100 bs2">
                  <span>年累计发电量（kWh）</span>
				  <span class="white f16 mt2">45369.23</span>
			   </div>
		   </div>
           <div class="ww50 hh33 plr5 flex-col-cc">
			   <div class="flex-col-cc ptb4 ww100 bs2">
                  <span>年减少碳排放（tCO2e）</span>
				  <span class="white f16 mt2">28579.23</span>
			   </div>
		   </div>
		</div>
