    ...
    <div class="layout-col ba1">
        <div class="h40 ww100 flex-sc relative mb10">
            ...
            <div class="ww100 hh100 flex-sc absolute pl35">
                <span class="fw flex1 ptb5">能耗异常</span>
                <div class="flex-ec hh70 plr12 mr15 rad30 bsred fFF6060">
                    {{publicStore._public.list?publicStore._public.list.filter(a=>a.type == 3).length:'0'}}
                </div>
            </div>
        </div>
        <div class="p10 flex1 overlay">
            <div class="flex-col" v-for="(v, i) in publicStore._public.list?publicStore._public.list.filter(a=>a.type == 3):[]" :key="i">
                <div class="flex-col ww100 bs4">
                    ...
                    <div class="flex-sc pt10">
                        <span class="pl15 i21 ww20">用电量</span>
                        <span class="">{{v.power_consumption}} kwh</span>
                    </div>
