<template>
  <div class="layout-col">
    ...
    <div class="layout-col p20 ba1">
      <div class="hh100 ww100" id="Line_loadData2"></div>
    </div>
  </div>
</template>
...
<script lang="ts" setup>
  ...
  watch(() => publicStore._public.loadData2, async(val, old) => {
	...
	const setChart = async() => {
		...
		let data = publicStore._public.loadData2
		let series = {data: []}
		series = data.map(v => {
