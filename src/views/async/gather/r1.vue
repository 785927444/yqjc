  ...
  <div class="layout-col">
	...
	<div class="h40 ww100 flex-sc relative mb10">
		...
		<div class="ww100 hh100 flex-sc absolute pl35">
			<span class="fw flex1 ptb5">功率检测</span>
			<div class="flex-ec flex1"></div>
		</div>
	</div>
    <!-- 内容 -->
    <div class="layout-col p20 ba1">
      <div class="hh100 ww100" id="Line_monitorData"></div>
    </div>
  </div>
</template>
...
<script lang="ts" setup>
  ...
  watch(() => publicStore._public.monitorData, async(val, old) => {
	...
	const setChart = async() => {
		...
		let data = publicStore._public.monitorData
		let series = {data: []}
		series = data.map(v => {
