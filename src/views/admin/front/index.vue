...
<script lang="ts" setup>
  ...
  const state = reactive({
    ...
    content: [
      ...
      { width: 'w50x5', show: true, align: 'left', key: 'localSvcIP', name: 'IP/串口号' }, 
      { width: 'w50x5', show: true, align: 'left', key: 'localSvcPort', name: '端口/波特率' }, 
  ...
  onMounted(async() => {
    ...
    let query2 = {model: "t_sensor_template", args: `attribute='2'`}
