  ...
  <div class="layout-col flex4 ml16">
    ...
    <div class="h40 ww100 flex-sc relative mb10">
      ...
      <div class="ww100 hh100 flex-sc absolute pl35">
        <span class="fw flex1 ptb5">配置 - {{!isNull(publicStore.active)?publicStore.active.name:''}}</span>
...
<script lang="ts" setup>
  ...
  const state = reactive({
    ...
    content: [
      ...
      { width: 'w50x4',   show: true, align: 'left', key: 'code', name: '配置点' },
      { width: 'w50x4', show: true, align: 'left', key: 'type', name: '配置类型', type: 'select', list: dictStore.cygType, value: 'type', label: 'name' },
