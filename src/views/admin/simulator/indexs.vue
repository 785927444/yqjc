          ...
          <div v-show="item.show" class="flex-col hh100 ww100" v-for="(v, i) in item.apis" :key="i">
            <div class="flex-sc c4">
              ...
              <div class="hh100 plr12 ptb14 bo-ce-1 flex4 bgi13 flex-bc relative">
                ...
                <div class="flex-ec">
                  <div class="cursor i6 flex-cc mr12" @click.stop="item.apis.push(JSON.parse(JSON.stringify(v)))">
              ...
              <div class="flex-sc c4" v-for="(vv, ii) in v.paramsType==1?v.params1:v.params2" :key="ii">
                <div class="hh100 plr12 ptb14 bo-ce-1 flex1 bgi13 flex-bs">
                  ...
                  <div class="flex-ec">
                    ...
                    <div class="cursor i1 flex-cc mr12" @click.stop="v.paramsType==1?v.params1.push(JSON.parse(JSON.stringify(vv))):v.params2.push(JSON.parse(JSON.stringify(vv)))">
                      <i-ep-connection class="f12 fw" /><span class="f14 ml2">复制</span>
                    </div>
                ...
                <div class="hh100 plr12 ptb14 bo-ce-1 flex4 bg-white flex-bc" v-if="v.paramsType==2">
                  <div class="flex-col-ss flex1">
                    <div class="flex-ss ww100" :class="iii!=0?'mt14 pt14 bot-ce-1':''" v-for="(vvv, iii) in vv.json" :key="iii">
                        ...
                        <div class="flex-sc">
                          <span>类型</span>
                          <el-select style="width: 150px" class="mlr10" v-model.trim="vvv.type" placeholder="请选择">
                            <el-option v-for="item in types" :key="item.value" :label="item.name" :value="item.value"/>
                          </el-select>
                        </div>
                        <div class="flex-sc">
                          <span>值类型</span>
                          <el-select style="width: 150px" class="mlr10" v-model.trim="vvv.valueType" placeholder="请选择"
                          @change="vvv.value=vvv.valueType==1||vvv.valueType==2?'': vvv.valueType==3?['','']:vvv.valueType==4||vvv.valueType==5?[{val: '', status: false}]:''">
                            <el-option v-for="item in valueTypes" :key="item.value" :label="item.name" :value="item.value"/>
                          </el-select>
                        </div>
                        <div class="flex-sc flex1">
                          ...
                          <div class="flex1 flex-sc" v-if="vvv.valueType==2">
                            <el-select style="width: 100%" class="ml10" v-model.trim="vvv.value" placeholder="请选择">
                              <el-option v-for="item in timeTypes" :key="item.value" :label="item.name" :value="item.value"/>
                            </el-select>
                          </div>
