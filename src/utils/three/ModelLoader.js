...
const dracoLoader = new DRACOLoader() // 加载draco模型(加载基于Google Draco压缩格式的3D模型的类)
dracoLoader.setDecoderPath('js/draco/') // 设置draco模型解码器路径
const loader = new GLTFLoader() // 加载gltf模型
