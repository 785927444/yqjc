  ...
  export function geoMercatorCoord(longitude, latitude) {
    var E = longitude
    var N = latitude
   ...
   * @returns
   */
  export function geoSphereCoord(R, longitude, latitude) {
   ...
   * @returns
   */
   export function getBoundingBox(group) {
    // 包围盒计算模型对象的大小和位置
   ...
   * @returns
   */
   export function setMeshQuaternion(mesh, R, lon, lat) {
