   ...
   * @returns
   */
  export function createMapLine(data, materialOptions = {}, lineType = 'LineLoop', projection) {
    let materialOpt = deepMerge({ color: 0x00ffff }, materialOptions);
   ...
   * @returns
   */
   export function createLine(points, material, lineType = 'LineLoop') {
    let line = null;
    if (lineType === 'Line2') {
